...
- LabyNodeJS route configs mirror the protobuf split: `placement` and `alternateRouting` are sibling optional sections under one route stage config.
...
| LabyNodeJS field                     | Emitted JSON key                             | Protobuf field                   | Notes                                      |
| ------------------------------------ | -------------------------------------------- | -------------------------------- | ------------------------------------------ |
| `placement.initialThickness`         | `routing.placement.initialThickness`         | `Placement.initial_thickness`    | JSON uses camelCase.                       |
| `placement.decrementFactor`          | `routing.placement.decrementFactor`          | `Placement.decrement_factor`     | JSON uses camelCase.                       |
| `placement.minimalThickness`         | `routing.placement.minimalThickness`         | `Placement.minimal_thickness`    | JSON uses camelCase.                       |
| `placement.smoothingTension`         | `routing.placement.smoothingTension`         | `Placement.smoothing_tension`    | JSON uses camelCase.                       |
| `placement.smoothingIteration`       | `routing.placement.smoothingIteration`       | `Placement.smoothing_iteration`  | JSON uses camelCase.                       |
| `placement.maxRoutingAttempt`        | `routing.placement.maxRoutingAttempt`        | `Placement.max_routing_attempt`  | Serialized as a string for protobuf JSON.  |
| `placement.routing.seed`             | `routing.placement.routing.seed`             | `RoutingCost.seed`               | Passed through unchanged.                  |
| `placement.routing.maxRandom`        | `routing.placement.routing.maxRandom`        | `RoutingCost.max_random`         | JSON uses camelCase.                       |
| `placement.routing.distanceUnitCost` | `routing.placement.routing.distanceUnitCost` | `RoutingCost.distance_unit_cost` | JSON uses camelCase.                       |
| `placement.routing.viaUnitCost`      | `routing.placement.routing.viaUnitCost`      | `RoutingCost.via_unit_cost`      | JSON uses camelCase.                       |
| `placement.cell.seed`                | `routing.placement.cell.seed`                | `Cell.seed`                      | Passed through unchanged.                  |
| `placement.cell.maxPin`              | `routing.placement.cell.maxPin`              | `Cell.maxPin`                    | Same name in TypeScript and protobuf JSON. |
| `placement.cell.startNet`            | `routing.placement.cell.startNet`            | `Cell.startNet`                  | Same name in TypeScript and protobuf JSON. |
| `placement.cell.resolution`          | `routing.placement.cell.resolution`          | `Cell.resolution`                | Passed through unchanged.                  |

#### Alternate Routing Fields

| LabyNodeJS field                    | Emitted JSON key                            | Protobuf field                      | Notes                                            |
| ----------------------------------- | ------------------------------------------- | ----------------------------------- | ------------------------------------------------ |
| `alternateRouting.maxThickness`     | `routing.alternateRouting.maxThickness`     | `AlternateRouting.maxThickness`     | Emitted whenever `alternateRouting` is provided. |
| `alternateRouting.minThickness`     | `routing.alternateRouting.minThickness`     | `AlternateRouting.minThickness`     | Emitted whenever `alternateRouting` is provided. |
