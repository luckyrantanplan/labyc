...
class PolygonTools {
public:
    static Linear_polygon makeTrapeze(const Point_2& a, const Point_2& b, const double& thickness1, const double& thickness2);
    ...
    static const Linear_polygon::Segment_2 getSegmentContainingPoint(const Linear_polygon& p1, const Point_2& center);
