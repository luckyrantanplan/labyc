...
// @@protoc_insertion_point(message_byte_size_start:proto.RoutingCost)
  ...
  // uint32 max_random = 2;
  if (this->_internal_max_random() != 0) {
    totalSize += ::_pbi::WireFormatLite::UInt32SizePlusOne(this->_internal_max_random());
  }

  // uint32 distance_unit_cost = 3;
  if (this->_internal_distance_unit_cost() != 0) {
    totalSize += ::_pbi::WireFormatLite::UInt32SizePlusOne(this->_internal_distance_unit_cost());
  }

  // uint32 via_unit_cost = 4;
  if (this->_internal_via_unit_cost() != 0) {
    totalSize += ::_pbi::WireFormatLite::UInt32SizePlusOne(this->_internal_via_unit_cost());
  }
