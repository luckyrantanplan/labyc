...
TEST(CircleIntersectionTest, TwoIntersections) {
    ...
    K::Point_2 const center(0, 0);
    K::Point_2 const a(-10, 0);
    K::Point_2 const b(10, 0);
    ...
    double const x0 = CGAL::to_double(result[0].x());
    double const y0 = CGAL::to_double(result[0].y());
    double const x1 = CGAL::to_double(result[1].x());
    double const y1 = CGAL::to_double(result[1].y());
...
TEST(CircleIntersectionTest, NoIntersection) {
    ...
    K::Point_2 const center(0, 0);
    K::Point_2 const a(10, 10);
    K::Point_2 const b(20, 10);
...
TEST(CircleIntersectionTest, TangentIntersection) {
    ...
    K::Point_2 const center(0, 0);
    K::Point_2 const a(-10, 5);
    K::Point_2 const b(10, 5);
...
TEST(CircleIntersectionTest, VerticalLine) {
    ...
    K::Point_2 const center(5, 5);
    K::Point_2 const a(5, -10);
    K::Point_2 const b(5, 20);
